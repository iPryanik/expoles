...
WELCOME_MESSAGE = os.getenv("WELCOME_MESSAGE", "Вас приветствует телеграм бот технической поддержки компании Эксполес. Напишите, что случилось и я передам это нашим специалистам")
